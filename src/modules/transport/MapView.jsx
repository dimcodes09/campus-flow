...
export default function MapView({ selectedBusId, visibleBusIds = [] }) {
  ...
  return (
    <div className="relative h-full w-full rounded-2xl overflow-hidden border border-white/10 bg-black/30 backdrop-blur">
      <div id="map" className="h-full w-full" />

      {/* LEGEND */}
      <div className="absolute bottom-3 left-3 bg-black/70 backdrop-blur px-3 py-2 rounded-lg text-xs space-y-1">
